...
<body class="bg-gray-100 min-h-screen">
    <div class="max-w-3xl mx-auto py-10 px-4">
        ...
        <div class="rounded-lg bg-white p-6 shadow">
            ...
            <form action="{{ route('devices.schedules.update', [$device, $schedule]) }}" method="POST" class="space-y-6">
                @csrf
                @method('PUT')
                ...
                <div>
                    ...
                    <input
                        ...
                        min="1"
                        max="300"
                        value="{{ old('duration_seconds', $schedule->duration_seconds) }}"
                        class="w-full rounded border px-3 py-2"
                        required>
                </div>
                ...
                <div class="flex items-center gap-2">
                    <input
                        ...
                        @checked(old('is_enabled', $schedule->is_enabled))>
                    <label for="is_enabled">Enable this schedule</label>
                </div>
