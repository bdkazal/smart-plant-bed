    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .tab {
            ...
            background: rgba(255,255,255,.82); color: var(--ink); font-size: 14px; font-weight: 850;
            text-decoration: none; box-shadow: 0 10px 26px rgba(15,23,42,.08);
        }
        ...
        .phone-frame {
            max-width: 480px; margin: 0 auto; padding: 16px; border-radius: 42px;
            background: rgba(255,255,255,.72);
            box-shadow: 0 34px 80px rgba(15,23,42,.16), inset 0 0 0 1px rgba(255,255,255,.92);
        }
        .app-screen {
            overflow: hidden; border-radius: 30px; min-height: 760px;
        ...
        .hero {
            position: relative; overflow: hidden; margin-bottom: 14px; padding: 18px; border-radius: 28px; color: #fff;
            background:
        ...
        .subtitle { margin: 8px 0 0; color: #cbd5e1; font-size: 13px; line-height: 1.42; }
        .status-pill {
            flex: 0 0 auto; display: inline-flex; align-items: center; gap: 7px; border-radius: 999px;
            padding: 8px 11px; background: rgba(34,197,94,.16); color: #bbf7d0;
            border: 1px solid rgba(187,247,208,.22); font-size: 12px; font-weight: 950; text-transform: uppercase;
        }
        ...
        .hero-meta { display: grid; grid-template-columns: 1fr 1fr; gap: 9px; margin-top: 16px; position: relative; z-index: 1; }
        .meta-card { border-radius: 16px; padding: 11px; background: rgba(255,255,255,.10); border: 1px solid rgba(255,255,255,.12); backdrop-filter: blur(12px); }
        .meta-label { margin: 0 0 4px; color: #bfdbfe; font-size: 11px; font-weight: 850; }
        .meta-value { margin: 0; color: #fff; font-size: 13px; font-weight: 900; }

        .glass-card {
            margin-bottom: 13px; border-radius: 24px; border: 1px solid rgba(255,255,255,.88); background: rgba(255,255,255,.78);
        ...
        .input, .select, .color-input {
            width: 100%; border-radius: 15px; border: 1px solid rgba(148,163,184,.38); background: rgba(255,255,255,.94);
            color: var(--ink); font-size: 15px; font-weight: 800; outline: none;
        }
