    ...
    <style>
        ...
        * {
        ...
        .hero {
            ...
            border-radius: 28px;
            color: #fff;
            background: radial-gradient(circle at 82% 18%, rgba(56, 189, 248, .55), transparent 8rem), radial-gradient(circle at 86% 86%, rgba(34, 197, 94, .18), transparent 9rem), linear-gradient(145deg, #132033 0%, #061225 100%);
